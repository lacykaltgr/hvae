...
def _model():
    from src.hvae.block import SimpleGenBlock, InputBlock, OutputBlock, TopGenBlock
...
log_params = Hyperparams(
    ...
    # EVAL
    # --------------------
    load_from_eval='2023-09-23__15-55/checkpoints/checkpoint-300.pth',


    # SYNTHESIS
    # --------------------
    load_from_analysis='2023-09-23__15-55/checkpoints/checkpoint-300.pth',
)
...
analysis_params = Hyperparams(
    ...
    ops=['reconstruction', 'generation', 'white_noise_analysis'],
